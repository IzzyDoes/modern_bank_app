...
const FeatureCard = ({ icon, title, content, index }) => (
  ...
  feature-card`}>
    ...
    <div className="flex-1 flex-col ml-3">
      <h4 className="text-white font-semibold font-poppins text-[18px]
       leading-[23px] mb-1">
        {title}
      </h4>
      <p className="text-white font-semibold font-poppins text-[16px]
       leading-[24px] mb-1">
        {content}
      </p>
    </div>
    ...
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          earning rewards and saving money. But with hundreds of credit cards
          on the market.
        </p>
        <Button styles="mt-10" />
      </div>
